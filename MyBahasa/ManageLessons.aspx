...
<form id="form1" runat="server">
    <div class="container">
        ...
        <asp:Panel ID="pnlForm" runat="server" Visible="false">
            ...
            <div class="mb-3">
                <label>Audio URL (optional):</label><br />
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Actions">
                    <ItemTemplate>
                        ...
                        <asp:Button runat="server" CommandName="ManageQuestions" CommandArgument='<%# Eval("lesson_id") %>' Text="Manage Questions" CssClass="btn-primary" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
